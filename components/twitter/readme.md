<p align="center">
  ...
  <p align="center">Use Twitter as an <a href="#event-sources">source</a> to trigger any code on any event (e.g., new Tweets), or integrate any Twitter API (e.g., post a Tweet) on events from any app, HTTP request or schedule.</p>
</p>
