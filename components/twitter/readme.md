<p align="center">
  ...
  <p align="center">From breaking news and entertainment to sports and politics, from big events to everyday interests. If it's happening anywhere, it's happening on Twitter. Use Twitter as an <a href="#event-sources">event source</a> to trigger code on any Twitter event (e.g., new Tweets) or as an <a href="#actions">action</a> to connect to any API (e.g., post a Tweet).</p>
</p>
